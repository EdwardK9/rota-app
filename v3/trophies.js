...
const FAMILIES = [
  ...
  { code: 'stays_late_10', icon: '🕯️', name: 'Just Finishing Up', unit: 'count',
    blurb: 'Clock-outs a full 10 minutes or more after your shift ended.',
    stat: 'lateOutBy10Count', need: [5, 20, 50, 100] },
...
function trophyValues(s) {
  return {
    ...
    lateOutBy10Count: s.lateOutBy10Count,
